...
export function Topbar() {
  ...
  if (pathname === "/dashboard/events") {
    ...
    title = "SDK Setup";
    subtitle = "Integrate the GameTrace SDK into your Unity build";
  ...
  return (
    <header className="h-20 border-b border-zinc-800/60 bg-zinc-950 flex items-center justify-between px-8 sticky top-0 z-40">
      <div>
        <div className="flex items-center gap-3 mb-1">
          <h1 className="text-xl font-bold text-white tracking-tight">{title}</h1>
          <div className="px-2 py-0.5 rounded-full bg-green-500/10 border border-green-500/20 text-green-500 text-xs font-medium flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-4 text-zinc-400">
        <div className="relative">
          ...
          <input 
            ...
            className="bg-zinc-900 border border-zinc-800/60 rounded-lg pl-9 pr-4 py-1.5 text-sm w-64 outline-none focus:border-orange-500/50 text-zinc-200 placeholder:text-zinc-600 transition-colors"
          />
        </div>
